...
export default async function EmpresaBrandingPage() {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm text-gray-500">
          Personaliza cómo ven tu portal los empleados de tu empresa:
          color primario, logo y favicon. Los cambios se aplican a todo
          el portal empresa y también al portal empleado dentro del
          mismo subdominio.
        </p>
      </div>
