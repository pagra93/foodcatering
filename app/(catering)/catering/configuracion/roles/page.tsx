...
export default function CateringRolesPage() {
  const roles = rolesByTenantType('CATERING')
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold">Roles del Catering</h1>
              ...
              <div className="mt-4 border-t pt-3">
                ...
                <ul className="space-y-1.5">
                  {permissions.map((p) => (
                    ...
                    >
                      <span className="mt-0.5 font-mono text-amber-600">✓</span>
                      <span>
