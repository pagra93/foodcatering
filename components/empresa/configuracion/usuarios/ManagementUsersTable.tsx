...
import {
  createEmpresaUserAction,
  deleteEmpresaUserAction,
  resetEmpresaUserPasswordAction,
  toggleEmpresaUserStatusAction,
  updateEmpresaUserAction,
} from './actions'
...
export function ManagementUsersTable({
  users,
  currentUserId,
}: {
  users: UserRow[]
  ...
  const [cRole, setCRole] = useState<UserRole>('RRHH')
      ...
      {showCreate && (
        <Card className="p-5">
          <form onSubmit={submitCreate} className="space-y-4">
            <h3 className="text-base font-semibold">Nuevo usuario de gestión</h3>
          ...
          <tbody>
                  ...
                  <td className="px-4 py-3">
                    {isEditingRole ? (
                      ...
                      <button
                        ...
                        disabled={isSelf}
                        title={isSelf ? 'No puedes cambiar tu propio rol' : 'Clic para cambiar'}
                      >
                        {u.role}
                      </button>
                    )}
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-1">
                      ...
                      <Button
                        ...
                        title={isSelf ? 'No puedes suspenderte' : 'Suspender/reactivar'}
                      >
                        {u.status === 'ACTIVE' ? (
            ...
            {users.length === 0 && (
              <tr>
                ...
                >
                  Aún no hay usuarios de gestión. Añade el primero con el botón
                  de arriba.
                </td>
              </tr>
            )}
