...
- Documentación de arquitectura estable (eso va en `docs/general/arquitectura/`).
- PRD global del producto (eso es `docs/producto/prd.md`).
- Runbook operativo (es `docs/general/despliegue/RUNBOOK.md`).
- Retrospectivas generales (si se hacen, ir a `docs/general/archive/`).
...
3. Si pasado un año la feature ha cambiado tanto que los docs son
   irrelevantes, mover al `docs/general/archive/` (no borrar, trazabilidad).
