...
| Scaffolding PM x10 | 2026-04-18 | ✅ | `tasks/`, `memory/`, `qa-reports/`, `working-docs/`, `PROJECT_KNOWLEDGE.md`, `project-registry.md` |
...
5. `/build` → implementar (seguir patrones en `CLAUDE.md` + `tasks/lessons.md`).
6. `/save` → commit + push.
7. `/review` → QA + docs.

Artefactos en `docs/working-docs/<feature>/`.
