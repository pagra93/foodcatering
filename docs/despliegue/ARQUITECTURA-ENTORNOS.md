...
- **Dev** no tiene datos reales. Solo fixtures del `pnpm db:seed` (usuarios
  de prueba con credenciales fijas — ver `docs/desarrollo/CREDENCIALES-PRUEBA.md`).
...
- **Comandos operativos**: `docs/despliegue/RUNBOOK.md`.
- **Histórico y contexto**: `docs/PROJECT_KNOWLEDGE.md`.
