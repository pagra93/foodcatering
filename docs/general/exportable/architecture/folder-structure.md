...
│
├── docs/producto/qa.md                   Audit trail de QA
│
...
1. **`docs/general/PROJECT_KNOWLEDGE.md`** — estado actual, decisiones, tech debt.
2. **`CLAUDE.md`** — reglas y contexto de trabajo.
3. **`docs/producto/sprint.md`** — qué hay en vuelo.
4. **`docs/producto/lessons.md`** — errores del pasado a no repetir.
5. Este documento (`docs/general/exportable/`) si necesito más profundidad.
...
- **Entornos**: `docs/general/despliegue/ARQUITECTURA-ENTORNOS.md` (qué apunta a
  qué) y `docs/general/despliegue/RUNBOOK.md` (cómo operar).
