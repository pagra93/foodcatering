...
- `docs/general/despliegue/ARQUITECTURA-ENTORNOS.md` con diagrama y reglas.
- `docs/general/despliegue/RUNBOOK.md` con 12 escenarios operativos copy-paste.
...
- Scaffolding PM x10 completo:
  - `docs/general/PROJECT_KNOWLEDGE.md` (conocimiento vivo).
  - `docs/general/project-registry.md` (inventario técnico).
  - `docs/producto/features/` (artefactos por feature).
  - `docs/producto/sprint.md`, `docs/producto/lessons.md`.
  - `memory/MEMORY.md` (memoria compartida entre sesiones Claude).
  - `docs/producto/qa.md`.
- Documentación humana completa en `docs/general/exportable/` (este árbol).

### Cambiado
- `CLAUDE.md` extendido con secciones Navigation, Orchestration Rules,
  Commands PM x10 y reglas estrictas de entornos.
- `docs/general/ESTADO.md` convertido a redirect stub → `PROJECT_KNOWLEDGE.md`.
