...
```
docs/general/PROJECT_KNOWLEDGE.md   ← estado actual
docs/producto/sprint.md                ← sprint activo
docs/producto/lessons.md             ← patrones/errores a evitar
docs/general/exportable/           ← referencia detallada (lo que estás leyendo)
```
